...
class Question:
    def __init__(self,windowsize:tuple[int,int])->None:
        ...
        buttontext:pygame.Surface = pygame.font.Font("src/font/PressStart2P-Regular.ttf",25).render("Tovább",True,self.textcolor)
        ...
        entrytext:pygame.Surface = pygame.font.Font("src/font/PressStart2P-Regular.ttf",18).render("Szimulációs idő: (x fél óra)",True,self.textcolor)
