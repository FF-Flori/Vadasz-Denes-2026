...
Ez röviden azt jelenti, hogy először generálunk sok véletlen sorozatot, ami az állomások bejárási sorrendjét adja, majd a jó sorozatokat visszük tovább, valamit mutációkat hajtunk végre rajtuk.
...
A 'fitness' függvény pontszámot ad a sorozatoknak, ami alapján eldöntjük, hogy a következő iterációra melyeket visszük tovább.
Nálunk a pontszám az időkorláton belül sikeresen kiszedett ércek száma.

## Végleges útvonal kiszámolása
A genetikus algoritmus által visszaadott legjobb sorozaton még optimalizálni kell a sebességfokozatokat, ezért egy újabb algoritmust vetettünk be, amit BFS-nek (Breadth First Search) hívnak.
...
A BFS algoritmus egyik alapelve, hogy a leghamarabb célt érő állapotsorozat lesz a legoptimálisabb.
...
> A videón a szimulációt összegző dashboard látható, aminek segítségével megbizonyosodhatunk arról, hogy a Pathfinder jól végezte dolgát.